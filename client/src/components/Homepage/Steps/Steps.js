    ...
    return (
        ...
        <section className="step-section" id="steps">
                ...
                <div className="row justify-content-around">
                    <Waypoint onEnter={props.onVisible} bottomOffset="30%">
                        <div className={`col-md-6  ${styles.StepBox}`}>
                            <Animated animationIn="bounceIn" isVisible={props.isVisible}>
                                <img src={appIphone} alt="iphone image" className={styles.appScreen}  />
                            </Animated>
                        </div>
                    </Waypoint>
                    <div className={`col-md-6  ${styles.StepBox}`}>
